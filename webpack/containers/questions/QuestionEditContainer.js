...
class QuestionEditContainer extends Component {
  ...
  componentDidMount() {
    this.props.setSteps([
      ...
      {
        title: 'Find code mappings',
        text: 'Click the search icon to search for and add coded code mappings to the question.',
        selector: '.fa-search',
        position: 'right',
      },
      {
        title: 'Create Your Own code mappings',
        text: 'Alternatively, you can manually add a code mapping - click the plus sign to add additional code mappings to associate with the question.',
        selector: '.fa-plus',
        position: 'top',
      },
      {
        title: 'Create Your Own code mappings (Name)',
        text: 'The code mapping Name field is what the user will see on the page.',
        selector: '.display-name-column',
        position: 'top',
      },
      {
        title: 'Create Your Own code mappings (Value / Code System)',
        text: 'Enter the code or value for the code mapping to be associated with that code mappings name (for examples see code mappings info popup or help documentation page). Optionally, you can enter a code and a code system for the code mapping you are adding if it belongs to an external system (such as LOINC or SNOMED).',
