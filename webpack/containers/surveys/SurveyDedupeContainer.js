...
class SurveyDedupeContainer extends Component {
  constructor(props) {
    ...
    this.props.params.action = 'dedupe';
  ...
  actionWord() {
    const wordMap = {'new': 'Create', 'revise': 'Revise', 'extend': 'Extend', 'edit': 'Edit', 'dedupe' : 'De-duplicate'};
        ...
        <div className="row">
          <div className="panel panel-default">
            ...
            <div className="panel-body">
              <SurveyDedupe ref='survey' survey={this.props.survey}
