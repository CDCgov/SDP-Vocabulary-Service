...
function mapStateToProps(state, ownProps) {
  let section = {};
  if (state.sections[ownProps.params.sectionId] && state.sections[ownProps.params.sectionId].questions && typeof state.sections[ownProps.params.sectionId].questions[0] === 'number') {
