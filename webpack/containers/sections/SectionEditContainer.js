            ...
            <Row className="panel-body">
              <Col md={5}>
                <div className="add-question">
                  ...
                  <Button bsStyle='link' onClick={() => this.setState({showInfoAddNewQuestion: true})}><i className="fa fa-info-circle" aria-hidden="true"></i><text className="sr-only">Click for info about this item</text></Button>
                </div>
                <InfoModal show={this.state.showInfoSearchAndSelectQuestionsOrSections} header="Search and Select Questions or Sections" body={<p>Search through existing Questions and Sections in the system to identify the content that composes this Section. A section is a grouping of related questions intended to appear together on a data collection instrument.
                  <br/><br/><u>Adding Questions</u>: Existing Questions in the repository can be searched from the “Questions” tab. To select a specific Question, click the blue “+” button. Once added, the “+” sign will change into a checkmark to indicate the Response Set will be added to this Section after save.
                  ...
                  <br/><br/>Existing Sections in the repository can be searched from the “Sections” tab. To select a specific Section, click the blue “+” button. Once added, the “+” sign will change into a checkmark to indicate the Section will be added to this Section after save.</p>} hideInfo={()=>this.setState({showInfoSearchAndSelectQuestionsOrSections: false})} />
                <label htmlFor="searchAndSelectQuestionsOrSections">Search and Select Questions or Sections<Button bsStyle='link' onClick={() => this.setState({showInfoSearchAndSelectQuestionsOrSections: true})}><i className="fa fa-info-circle" aria-hidden="true"></i><text className="sr-only">Click for info about this item</text></Button></label>
