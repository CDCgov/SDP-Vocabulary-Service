    ...
    return (
      <div className={`basic-c-box panel-default ${this.props.type}-type`}>
        ...
        <div className="box-content">
          ...
          <br/>
          <br/>
          {this.props.duplicateOf && this.props.contentStage === 'Duplicate' ? (
            <div className="box-content">
        ...
        <div className="box-content">
          ...
          <br/>
          <br/>
          {this.props.suggestedReplacementOf && this.props.suggestedReplacementOf.length > 0 && this.props.objSetName ? (
            <div className="box-content">
              {GetSuggestedRepOf(this.props.objSetName, this.props.suggestedReplacementOf)}
            </div>
          ) : (
            <div className="box-content">
              <p>No links currently.</p>
