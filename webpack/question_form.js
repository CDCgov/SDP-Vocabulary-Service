...
ReactDOM.render(<QuestionForm question={question} selectedResponseSets={selectedResponseSets} responseSets={responseSets} questionTypes={questionTypes} responseTypes={responseTypes} routes={Routes}/>, document.getElementById('react-container'));
