module Api
  module Fhir
    class QuestionairesController < ApplicationController
      def index
        @@tracker.pageview(path: "/api/FHIR/questions/#{params[:limit]}", hostname: Settings.default_url_helper_host, title: 'API FHIR Question Show - Search content: ' + "#{params[:_content]}")
