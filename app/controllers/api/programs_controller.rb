module Api
  class ProgramsController < Api::ApplicationController
    ...
    def index
      @@tracker.pageview(path: "/api/programs/#{params[:limit]}", hostname: Settings.default_url_helper_host, title: 'API Programs Show - Search criteria: ' + "#{params[:search]}")
