...
describe('QuestionShowContainer ', () => {
  it('will show a question', () => {
    const props = {
      question: {id: 1, concepts: [], content: "Is this a question?", createdBy: { email: "test@test.com" }, category: ""},
      params: {qId: 1},
      router: {}
    };
    const state = {
      questions: {1: {id:1, concepts: [], createdBy: {email: 'test'}, content:'test', categoryId:1, responseTypeId:1, responseSets:[1]}},
