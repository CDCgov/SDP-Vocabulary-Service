...
class ElasticSearchTest < ActiveSupport::TestCase
  ...
  def test_search_on_string
    ...
    assert_equal '/question,section,response_set,survey/_search', req.path
  end
  ...
  def test_search_on_type
    ...
    req = FakeWeb.last_request
    assert_equal 'GET', req.method
    assert_equal '/section/_search', req.path
  end
  ...
  def test_delete_all
    ...
    assert_equal '/section/_delete_by_query', req.path
  end
  ...
  def find_duplicate_questions
    ...
    req = FakeWeb.last_request
    assert_equal 'GET', req.method
    assert_equal '/question/question/_search', req.path
  end
